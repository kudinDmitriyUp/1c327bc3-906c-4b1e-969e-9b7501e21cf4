...
export const metadata: Metadata = {
  title: "Bevel - Luxury Boutique Hotel Experience",
  description: "Experience luxury redefined at Bevel. Premium boutique hotel with personalized service, fine dining, spa, and rooftop terrace in the heart of the city.",
  keywords: "luxury hotel, boutique hotel, fine dining, spa resort, upscale accommodation",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Bevel Luxury Boutique Hotel",
    description: "Experience luxury redefined. Personalized service, stunning design, and unforgettable moments.",
    type: "website",
    siteName: "Bevel",
  },
  twitter: {
    ...
    title: "Bevel - Luxury Boutique Hotel",
    description: "Experience luxury hospitality at Bevel",
  },
};
